...
nn = FeedForwardNN(input_size, hidden_layers, output_size,activation='relu',weight_init='random_init', learn_rate=0.001, grad_desc='adam')
...
# Train the model
nn.train(X_train, y_train_one_hot,batch_size=40, epochs=2,val_split=0.1)
